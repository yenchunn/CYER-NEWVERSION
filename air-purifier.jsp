...
<%
    ...
    pageContext.setAttribute("currentPage", "air");
    String categoryCode = "air-purifier";
    String categoryName = "空氣清淨機";
    String categorySubtitle = "潔淨空氣，提升呼吸品質";
%>
<!DOCTYPE html>
<html lang="zh-TW">
<head>
...
<section class="page-hero">
  <p class="page-hero-fr"><%= h(categoryCode) %></p>
  <h1 class="page-hero-title"><%= h(categoryName) %></h1>
  <p class="page-hero-sub"><%= h(categorySubtitle) %></p>
</section>
...
<%
            ...
            if (!hasProduct) {
%>
    <p class="empty-message">目前此分類尚無商品，請先匯入 database/database.sql。</p>
<%
            }
        }
    } catch (Exception e) {
