...
<%
    ...
    pageContext.setAttribute("currentPage", "vac");
    String categoryCode = "vacuum";
    String categoryName = "吸塵器";
    String categorySubtitle = "史上最輕手持吸塵器，輕鬆整理家中每個角落";
%>
<!DOCTYPE html>
<html lang="zh-TW">
<head>
