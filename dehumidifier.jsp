...
<%
    ...
    pageContext.setAttribute("currentPage", "de");
    String categoryCode = "dehumidifier";
    String categoryName = "除濕機";
    String categorySubtitle = "自動控制室內濕度，打造乾爽生活";
%>
<!DOCTYPE html>
<html lang="zh-TW">
<head>
