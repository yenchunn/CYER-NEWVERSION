...
<%
    ...
    boolean login = session.getAttribute("m_id") != null;
%>
<!DOCTYPE html>
<html lang="zh-TW">
<head>
...
<section class="page-hero">
  ...
  <p class="page-hero-sub">請確認收件資訊</p>
</section>
<% if (!login) { %>
  <main class="content-card">
    <div class="message">請先登入後再結帳。</div>
...
<% } else { %>
  <main class="form-card">
    <form action="order_process.jsp" method="post">
      ...
      <input id="phone" name="phone" value="<%= session.getAttribute("m_phone") == null ? "" : session.getAttribute("m_phone") %>" required>
