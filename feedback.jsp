...
然而，歷經了先前的教訓與洗禮，本次專案的組別，在其他課程已累積了豐富的合作經驗。為了能繳出良好的成果，我們這次採取了不同的策略，提早了至少一個月開始著手進行專案規劃，因此我們在時間進度上顯得游刃有餘。無論是前端遇到排版混亂，或是後端程式碼出現錯誤404，甚至是商品連接到資料庫，這種較複雜的問題，我們團隊都能在第一時間即時修正程式碼。<br><br>
