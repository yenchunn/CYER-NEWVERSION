...
<section class="page-hero">
  <p class="page-hero-fr">CYER Electric House</p>
  <h1 class="page-hero-title">質感家電選品</h1>
...
<main class="container page-section">
  ...
  <div class="cyer-product-grid">
    <article class="cyer-product-card"><div class="cyer-product-body"><h3>冰箱</h3><p>精準保鮮，照顧食材。</p><a class="btn-link" href="refrigerator.jsp">前往分類</a></div></article>
    <article class="cyer-product-card"><div class="cyer-product-body"><h3>空氣清淨機</h3><p>潔淨空氣，守護呼吸。</p><a class="btn-link" href="air-purifier.jsp">前往分類</a></div></article>
    <article class="cyer-product-card"><div class="cyer-product-body"><h3>電風扇</h3><p>安靜循環，涼爽舒適。</p><a class="btn-link" href="fan.jsp">前往分類</a></div></article>
    <article class="cyer-product-card"><div class="cyer-product-body"><h3>吹風機</h3><p>快速乾髮，柔順護理。</p><a class="btn-link" href="hairdryer.jsp">前往分類</a></div></article>
    <article class="cyer-product-card"><div class="cyer-product-body"><h3>除濕機</h3><p>穩定濕度，乾爽生活。</p><a class="btn-link" href="dehumidifier.jsp">前往分類</a></div></article>
    <article class="cyer-product-card"><div class="cyer-product-body"><h3>吸塵器</h3><p>輕巧吸力，俐落清潔。</p><a class="btn-link" href="vacuum.jsp">前往分類</a></div></article>
  </div>

  <section class="page-section">
    <h2 class="section-title">推薦商品</h2>
    <p class="section-subtitle">本月精選 TOP 3</p>
    <div class="cyer-product-grid">
<%
